          ...
          >
            ...
            <v-row class="mb-3">
              <v-btn
                outlined
                color="primary"
                class="ut-btn ut-btn--outlined"
              >
                <v-icon>mdi-download</v-icon>Export Tableur
              </v-btn>
            </v-row>
            <v-row align="start">
              <v-data-table
                ...
                <template v-slot:item.infos="{ item }">
                  <v-tooltip bottom>
                    <template v-slot:activator="obj">
                      <div
                        class="ut-table-cell__nowrap d-none d-lg-block"
                      ...
                      >
                        <div v-if="item.infos instanceof Object">
                          ...
                          >{{ key | capitalize }}: {{ val | capitalize }}</span>
                        </div>
...
<style lang="scss">
@import "@/styles/ugitech";

.ut-table-cell__nowrap {
  cursor: pointer;
  overflow: hidden;
...
.custom__separator:not(:last-child):after {
  content: "\0020-\0020";
}
</style>
